	...
	public Mesh (VertexDataType type, boolean isStatic, int maxVertices, int maxIndices, VertexAttributes attributes) {
		switch (type) {
			...
			case VertexBufferObjectWithVAO:
				vertices = new VertexBufferObjectWithVAORespecification(isStatic, maxVertices, attributes);
				indices = new IndexBufferObjectSubDataRespecification( isStatic, maxIndices);
				isVertexArray = false;
				break;
			case VertexArray:
			default:
