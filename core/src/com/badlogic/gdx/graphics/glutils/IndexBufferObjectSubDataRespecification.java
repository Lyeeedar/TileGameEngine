 ...
 *
 * @author mzechner */
public class IndexBufferObjectSubDataRespecification implements IndexData {
	...
	public IndexBufferObjectSubDataRespecification( boolean isStatic, int maxIndices ) {
	 ...
	 *
	 * @param maxIndices the maximum number of indices this buffer can hold */
	public IndexBufferObjectSubDataRespecification( int maxIndices ) {
		byteBuffer = BufferUtils.newByteBuffer(maxIndices * 2);
		this.isDirect = true;
	...
	public void setIndices (short[] indices, int offset, int count) {
		...
		if (isBound) {
			Gdx.gl20.glBufferData(GL20.GL_ELEMENT_ARRAY_BUFFER, byteBuffer.limit(), null, usage);
