 ...
 */
public class VertexBufferObjectWithVAORespecification implements VertexData {
	 ...
	 */
	public VertexBufferObjectWithVAORespecification (boolean isStatic, int numVertices, VertexAttribute... attributes) {
	 ...
	 */
	public VertexBufferObjectWithVAORespecification (boolean isStatic, int numVertices, VertexAttributes attributes) {
	...
	public VertexBufferObjectWithVAORespecification (boolean isStatic, ByteBuffer unmanagedBuffer, VertexAttributes attributes) {
		this.isStatic = isStatic;
		this.attributes = attributes;
